...
public class DBConnectingDAO {
	...
	public ArrayList<mainBoard_PpDTO> PpBoard1() {
		...
		try {
			...
			String query = "select * from lolboard order by isgood desc limit 10";
	...
	public ArrayList<mainBoard_PpDTO> PpBoard2() {
		...
		try {
			con = ds.getConnection();
			String query = "select * from starboard order by isgood desc limit 10";
			st = con.createStatement();
			rs = st.executeQuery(query);
	...
	public ArrayList<mainBoard_PpDTO> PpBoard3() {
		...
		try {
			con = ds.getConnection();
			String query = "select * from fifaboard order by isgood desc limit 10";
			st = con.createStatement();
			rs = st.executeQuery(query);
